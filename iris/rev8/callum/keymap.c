...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT(
        ...
        _______, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    _______, _______, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SCLN, _______, 
                                            LA_NAV,  KC_LSFT, _______, _______, KC_SPC,  LA_SYM
    ),
    ...
    [SYM] = LAYOUT(
        ...
        _______, KC_PLUS, KC_PIPE, KC_AT,   KC_SLSH, KC_PERC, _______, _______, XXXXXXX, KC_BSLS, KC_AMPR, KC_QUES, KC_EXLM, _______, 
    ...
    [NAV] = LAYOUT(
        ...
        _______, SPACE_L, SPACE_R, BACK,    FWD,     KC_MPLY, _______, _______, XXXXXXX, KC_PGDN, KC_PGUP, SW_LANG, KC_ENT,  _______, 
                                            _______, _______, _______, _______, _______, _______ 
    ),
