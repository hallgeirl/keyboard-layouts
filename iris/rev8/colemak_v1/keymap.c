...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NAV] = LAYOUT(
        ...
        _______, KC_HOME, CTLLEFT, KC_UP  , CTLRGHT ,KC_END ,                   _______, _______, _______, _______, KC_PSCR, EE_CLR , 
        _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP,                   KC_MPRV, C_MTCMN, C_MTCVU, KC_LALT, _______, QK_BOOT, 
